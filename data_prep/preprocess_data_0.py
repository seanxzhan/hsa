...
def export_data(split_ids: Dict, save_data=True, start=0, end=0,
    ...
    with open(
        f'data/{cat_name}_part_name_to_new_id_0_{start}_{end}.json',
        'w') as f:
    ...
    with open(
        f'data/{cat_name}_train_new_ids_to_objs_0_{start}_{end}.json',
        'w') as f:
    ...
    np.save(f'data/{cat_name}_union_node_names_0_{start}_{end}.npy',
            union_node_names)
    ...
    UniqueDotExporter(recon_root,
                      ...
                      nodeattrfunc=lambda node: "shape=box",
                          ...
                          f"data_prep/tmp/recon_tree_union_0_{start}_{end}.png")
    ...
    fn = f'data/{cat_name}_train_{pt_sample_res}_0_{start}_{end}.hdf5'
