...
# xformed_pts_path = f'data/{cat_name}_train_{pt_sample_res}_xforms_part_class_xformed_points_{ds_start}_{ds_end}.hdf5'
# xformed_pts_data = h5py.File(xformed_pts_path, 'r')
# if OVERFIT:
#     transformed_points = xformed_pts_data['transformed_points'][overfit_idx:overfit_idx+1]
#     empty_parts = xformed_pts_data['empty_parts'][overfit_idx:overfit_idx+1]
# else:
#     transformed_points = xformed_pts_data['transformed_points']
#     empty_parts = xformed_pts_data['empty_parts']
