...
from data_prep import preprocess_data_10
...
train_new_ids_to_objs_path = f'data/{cat_name}_train_new_ids_to_objs_10_{ds_start}_{ds_end}.json'
...
train_data_path = f'data/{cat_name}_train_{pt_sample_res}_10_{ds_start}_{ds_end}.hdf5'
...
for i in range(num_shapes):
    indices = preprocess_data_10.convert_flat_list_to_fg_part_indices(
...
if args.test:
    ...
    unique_part_names, name_to_ori_ids_and_objs,\
        ...
        preprocess_data_10.merge_partnet_after_merging(anno_id)

    with open(f'data/{cat_name}_part_name_to_new_id_10_{ds_start}_{ds_end}.json', 'r') as f:
