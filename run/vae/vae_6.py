...
from occ_networks.encoder_decoder_nasa import SmallMLPs
...
import math
embeddings = torch.nn.Embedding(num_shapes, 128).to(device)
if args.train:
    torch.nn.init.normal_(embeddings.weight.data, 0.0, 1 / math.sqrt(128))
