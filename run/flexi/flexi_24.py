...
from occ_networks.flexi_decoder_24 import SDFDecoder, get_embedder
...
def run_flexi(gt_mesh_idx, s, delta_sdf, deform, pred_occ, gt_meshes, test=False):
...
if args.train:
    for it in range(iterations):
        ...
        for b in range(5):
            ...
            delta_sdf, deform = model.get_sdf_deform(x_nx3, embed_feat)
