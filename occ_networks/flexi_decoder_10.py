...
class SDFDecoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.shared_net = SmallMLPs(feature_dims,
                                    0,
                                    internal_dims,
                                    hidden=2,
    ...
    def get_shared_feat(self, features):
        # print(points.unsqueeze(0).expand(10, -1, -1).shape)
        # print(features.unsqueeze(1).expand(-1, points.shape[0], -1).shape)
        # return self.shared_net(points.unsqueeze(0).expand(10, -1, -1),
        #                        features.unsqueeze(1).expand(-1, points.shape[0], -1))
                            #    features)
